...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(
            tf.float32, (self.config.batch_size, self.config.n_features), name="input")
        self.labels_placeholder = tf.placeholder(
            tf.float32, (self.config.batch_size, self.config.n_classes), name="labels")
    ...
    def add_prediction_op(self):
        ...
        assert pred.shape == (self.config.batch_size, self.config.n_classes)
        return pred
